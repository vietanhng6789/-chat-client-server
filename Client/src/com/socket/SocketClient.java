            ...
            try {
                ...
                if(msg.type.equals("message")){
                    ...
                    if(msg.content.equals("TRUE")){
                        ...
                        ui.jTextArea1.append("[SERVER > Me] : Dang Nhap Thanh Cong\n");
                        ui.jTextField3.setEnabled(false); ui.jPasswordField1.setEnabled(false);
                    }
                    else{
                        ui.jTextArea1.append("[SERVER > Me] : Dang Nhap That Bai\n");
                    }
                }
                    ...
                    if(msg.content.equals("TRUE")){
                        ui.jButton2.setEnabled(false); ui.jButton3.setEnabled(false);
                        ui.jButton4.setEnabled(true); ui.jButton5.setEnabled(true);
                        ui.jTextArea1.append("[SERVER > Me] : Dang Ky Thanh Cong\n");
                    }
                    else{
                        ui.jTextArea1.append("[SERVER > Me] : Dang Ky That Bai\n");
                    }
                }
                    ...
                    if(!msg.content.equals("NO")){
                        ...
                        ui.jTextArea1.append("[SERVER > Me] : "+msg.sender+" Tu Choi Tap Tin Yeu Cau\n");
                    }
                }
                else{
                ...
                keepRunning = false;
                ui.jTextArea1.append("[Application > Me] : Ket Noi That Bai\n");
